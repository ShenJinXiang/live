...
(m=["first"+e,"prev"+e,"next"+e,"last"+e],"rtl"===f&&m.reverse(),g+="<td id='"+m[0]+"' class=''><u style='cursor:pointer;margin-right:10px;'>首页</u></td>",g+="<td id='"+m[1]+"' class=''><u style='cursor:pointer;margin-right:10px;'>上一页</u></td>",g=g+(""!==d?"<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"+d+"<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>":
"")+("<td id='"+m[2]+"' class=''><u style='cursor:pointer;margin-left:10px;'>下一页</u></td>"),g+="<td id='"+m[3]+"' class=''><u style='cursor:pointer;margin-left:10px;margin-right:10px;'>尾页</u></td>"):""!==d&&(g+=d);"ltr"===f&&(g+=k);g+="</tr></tbody></table>";!0===a.p.viewrecords&&b("td#"+c+"_"+a.p.recordpos,"#"+l).append("<div dir='"+f+"' style='text-align:"+a.p.recordpos+"' class='ui-paging-info'></div>");b("td#"+c+"_"+a.p.pagerpos,"#"+l).append(g);k=b(".ui-jqgrid").css("font-size")||
